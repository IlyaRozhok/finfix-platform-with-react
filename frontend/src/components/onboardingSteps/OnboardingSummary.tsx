...
import { getCurrencyByCode } from "../../consts";

export function OnboardingSummary() {
  const { data, currentStep, isCompleted, resetOnboarding } =
    useOnboardingStore();
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button onClick={copyDataToClipboard} variant="outline" size="sm">
