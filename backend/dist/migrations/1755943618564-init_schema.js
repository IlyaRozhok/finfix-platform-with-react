...
exports.InitSchema1755943618564 = void 0;
class InitSchema1755943618564 {
    constructor() {
        this.name = "InitSchema1755943618564";
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp";`);
        await queryRunner.query(`CREATE TYPE "public"."category_kind" AS ENUM('expense', 'income')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cb98dd4ecdbf2e14a29bcfaf3c" ON "recurring_expense" ("start_date") `);
        await queryRunner.query(`CREATE TABLE "recurring_income" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "description" text NOT NULL, "amount" numeric(14,2) NOT NULL, "start_date" date NOT NULL, "end_date" date, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a61fffba1c4e85548b7fe42314a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c1299a1cc68bc85a348e406f8c" ON "recurring_income" ("start_date") `);
        ...
        await queryRunner.query(`CREATE INDEX "idx_transactions_user_date" ON "transactions" ("user_id", "occurred_at") `);
        ...
        await queryRunner.query(`ALTER TABLE "recurring_income" ADD CONSTRAINT "FK_e4428cb592ae36712ee4567f30d" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "recurring_income" DROP CONSTRAINT "FK_e4428cb592ae36712ee4567f30d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c1299a1cc68bc85a348e406f8c"`);
        await queryRunner.query(`DROP TABLE "recurring_income"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cb98dd4ecdbf2e14a29bcfaf3c"`);
...
exports.InitSchema1755943618564 = InitSchema1755943618564;
//# sourceMappingURL=1755943618564-init_schema.js.map